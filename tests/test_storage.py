...
class StorageTests(unittest.TestCase):
    ...
    def test_bot_setting_can_be_saved_updated_and_deleted(self) -> None:
        ...
        self.storage.set_setting("pick_prefix_html", "first")
        self.assertEqual(self.storage.get_setting("pick_prefix_html"), "first")
        self.storage.set_setting("pick_prefix_html", "second")
